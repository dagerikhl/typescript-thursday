...
type ParentComponentProps = Child1ComponentProps & Child2ComponentProps;
...
type ChildOfChild1ComponentProps = Child1ComponentProps & {
  border?: string;
};
/*
Alternative solution:
interface ChildOfChild1ComponentOwnProps {
  border?: string;
}
type ChildOfChild1ComponentProps = Child1ComponentProps & ChildOfChild1ComponentOwnProps;
 */
